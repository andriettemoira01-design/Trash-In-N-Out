          ...
          {showRewardModal && currentReward && (
            ...
            >
              <motion.div
                ...
                transition={{ type: "spring", damping: 25 }}
                onClick={(e) => e.stopPropagation()}
                className="bg-white rounded-3xl p-5 w-full max-w-md shadow-2xl max-h-[85vh] overflow-y-auto"
              >
                <h2 className="text-xl font-bold text-gray-800 mb-3">{currentReward.id ? "Edit" : "Add"} Reward</h2>
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="Enter description"
                      rows={2}
                      className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl outline-none focus:ring-2 focus:ring-purple-500/50 resize-none"
                    />
                  </div>
                ...
                <div className="flex gap-3 mt-4">
                  ...
                  <button
                    onClick={saveReward}
                    className="flex-1 py-2.5 bg-gradient-to-r from-purple-500 to-indigo-500 text-white rounded-xl font-semibold shadow-lg"
                  >
                    Save
                  </button>
                </div>
